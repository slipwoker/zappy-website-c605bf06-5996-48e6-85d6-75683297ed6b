  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        error = getFieldLabel(field, name) + ' is required.';
        ...
        if (value.length < min) {
          error = getFieldLabel(field, name) + ' must be at least ' + min + ' characters.';
        }
      } else if (field.hasAttribute('maxlength')) {
        const max = parseInt(field.getAttribute('maxlength'), 10);
        if (value.length > max) {
          error = getFieldLabel(field, name) + ' must not exceed ' + max + ' characters.';
        }
      }
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'c605bf06-5996-48e6-85d6-75683297ed6b',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'c605bf06-5996-48e6-85d6-75683297ed6b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c605bf06-5996-48e6-85d6-75683297ed6b';
